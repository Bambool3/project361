...
const mockKpi = [
  {
    ...
    type: "%",
    frequency: "รายไตรมาส",
    department: [{ id: "1", name: "งานนโยบายฝ่ายแผน" }],
    subkpi: [],
  },
  {
    id: "2",
    ...
    type: "จำนวนเต็ม",
    frequency: "รายไตรมาส",
    department: [{ id: "2", name: "งานบริหารงานวิจัย" }],
    subkpi: [],
  },
  {
    id: "3",
    ...
    subkpi: [
      {
        id: "301",
        name: "จำนวนผลงานวิจัยด้านสิ่งแวดล้อมและพลังงาน",
        target: "5",
      },
      {
        id: "302",
        name: "จำนวนผลงานวิจัยที่อยู่ในระดับ CMU-RL 4-7",
        target: "5",
      },
      {
        id: "303",
        name: "จำนวนนวัฒกรรมด้านอาหารและสุขภาพ และการดูแลผู้สูงอายุ",
        target: "5",
      },
    ],
  },

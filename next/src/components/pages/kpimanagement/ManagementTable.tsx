...
//                 <TableCell sx={{ fontWeight: "bold", color: "#475569", border: "none", py: 2 }}>
//                   ชื่อตัวชี้วัด
//                 </TableCell>
//                 <TableCell sx={{ fontWeight: "bold", color: "#475569", border: "none", py: 2, textAlign: "center" }}>
//                   เป้าหมาย
//                 </TableCell>
//                 <TableCell sx={{ fontWeight: "bold", color: "#475569", border: "none", py: 2, textAlign: "center" }}>
//                   หน่วย
...
//                       {searchTerm ? "ไม่พบตัวชี้วัดที่ค้นหา" : "ไม่มีข้อมูลตัวชี้วัด"}
//                     </Typography>
//                   </TableCell>
//                 </TableRow>
//               ) : (
...
//                           <IconButton onClick={() => handleEdit(kpi.id)} size="small" sx={{ color: "#64748b" }}>
//                             <Edit size={16} />
//                           </IconButton>
//                           <IconButton onClick={() => handleDelete(kpi.id)} size="small" sx={{ color: "#64748b" }}>
//                             <Trash2 size={16} />
//                           </IconButton>
//                         </Box>
//                       </TableCell>
...
//                             <Box sx={{ margin: 2 }}>
//                               <Typography variant="subtitle2" sx={{ mb: 1, color: "#1e293b", fontWeight: "550" }}>
//                                 รายการตัวชี้วัดย่อย:
//                               </Typography>
//                               <Table size="small">
//                                 <TableHead>
//                                   <TableRow>
//                                     <TableCell sx={{ py: 2, color: "#1e293b", fontWeight: "550" }}>
//                                       ชื่อตัวชี้วัดย่อย
//                                     </TableCell>
//                                     <TableCell sx={{ py: 2, color: "#1e293b", fontWeight: "550" }}>
//                                       เป้าหมาย

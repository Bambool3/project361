...
export default function RoleTableSection({
  ...
  //     if (response.status === 200) {
  //       showNotification("ลบหตำแหน่งสำเร็จ!", "success");
  //       if (onRefresh) {
  //         onRefresh();
  //       }
  //     } else if (response.status === 400) {
  ...
  //       showNotification(
  //         data.error || "ไม่สามารถลบหตำแหน่งที่มีบุคลากรที่เกี่ยวข้องได้",
  //         "warning"
  //       );
  //     } else if (response.status === 404) {
  //       showNotification("ไม่พบหตำแหน่งที่ต้องการลบ", "error");
  //     } else {
  //       showNotification("เกิดข้อผิดพลาดในการลบหตำแหน่ง", "error");
  //     }
  //   } catch (error) {
